  ...
  <div>
    ...
    <div class="mb-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
      <div 
        ...
        :key="index" 
        class="glass-card overflow-hidden rounded-xl border border-white/10 px-6 py-5 shadow-glow-white"
      >
    ...
    <!-- Empty state -->
    <div v-else-if="!assets.length" class="glass-card rounded-xl border border-dashed border-white/20 p-8 text-center shadow-glow-white">
      ...
      <p class="mt-1 text-sm text-dark-400">Get started by adding your first cryptocurrency asset.</p>
      <div class="mt-6">
        <router-link
