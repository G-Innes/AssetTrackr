...
<template>
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    <div class="glass-card rounded-xl border border-white/10 p-8 shadow-glow-white sm:mx-auto sm:w-full sm:max-w-md">
      <h2 class="mb-6 text-center font-display text-2xl font-bold text-white">Buy or Sell an Asset</h2>
      <form class="space-y-6" @submit.prevent>
        ...
        <div>
          ...
          <div class="mt-1">
            ...
            />
            <span v-if="errors.quantity" class="text-sm text-danger-500">{{ errors.quantity }}</span>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative mt-1">
            ...
            <ul
              ...
              class="absolute z-10 mt-1 max-h-48 w-full overflow-y-auto rounded-md border border-white/10 bg-dark-800/30 backdrop-blur-md shadow-lg"
            >
              <li
        ...
        <div>
          <label for="currentPrice" class="block text-sm font-medium text-dark-200">Current Price</label>
          <div class="mt-1">
            <p
        ...
        <div class="flex justify-between gap-4">
          <button
            ...
            class="flex w-full justify-center rounded-md bg-success-600 px-4 py-3 text-sm font-semibold text-white shadow-glow-success transition-all hover:bg-success-500"
          >
            Buy
          </button>
          <button
            ...
            class="flex w-full justify-center rounded-md bg-danger-600 px-4 py-3 text-sm font-semibold text-white shadow-glow-danger transition-all hover:bg-danger-500"
          >
            Sell
          </button>
        </div>
