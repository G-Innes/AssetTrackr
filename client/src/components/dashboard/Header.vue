...
<template>
  <header class="sticky top-0 z-10 flex h-16 shrink-0 items-center backdrop-blur-md">
    <div class="glass-card flex flex-1 items-center justify-between border-b border-white/10 bg-glass-gradient px-4 sm:px-6 lg:px-8">
      <!-- Mobile Menu Button -->
      <button
        type="button"
      ...
      <div class="relative ml-auto flex items-center gap-x-4">
        ...
        <div class="relative">
          ...
          >
            ...
            <div class="flex h-8 w-8 items-center justify-center rounded-full bg-primary-500 text-sm font-medium text-white shadow-glow-primary">
          ...
          <div 
            v-if="dropdownOpen" 
            class="glass-card absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md border border-white/10 bg-glass-gradient py-1 shadow-lg backdrop-blur-sm ring-1 ring-white/5 focus:outline-none"
          >
            <a href="#" class="block px-4 py-2 text-sm text-dark-200 hover:bg-white/10">Your Profile</a>
